            ...
            <div className="navbar flex flex-row justify-between items-center bg-transparent">
                <Link to="/">
                    <div className="flex-1 logo">
                        <h2 className="text font-bold">MENTALIA</h2>
                    </div>
                </Link>

                <ul className="flex-3 btns">
                    <Link to="/">
                        <li className="btn btn-ghost hover:shadow hover:rounded-full text-l NavLink">Home</li>
                    </Link>
                    <Link to="/meals">
                        <li className="btn btn-ghost hover:shadow hover:rounded-full text-l NavLink">meals</li>
                    </Link>
                    <Link to="/stepper">
                        <li className="btn btn-ghost hover:shadow hover:rounded-full text-l NavLink">Scheduler</li>
                    </Link>
                    <Link to="/coaches">
                        <li className="btn btn-ghost hover:shadow hover:rounded-full text-l NavLink">Coaches</li>
                    </Link>
                    <Link to="/contact">
                        <li className="btn btn-ghost hover:shadow hover:rounded-full text-l NavLink">Contact</li>
                    </Link>
                </ul>
                ...
                <div className="flex-none">
                    <span className="theme-toggle NavLink" onClick={toggleDarkMode}>
                        <i className="fa-solid fa-sun logo-forDark darkMode " ></i>
                        <i className="fa-solid fa-moon logo-forLight darkMode "  ></i>
                    </span>

                    {/* <div className="images">
                        <i className="fa-solid fa-sun logo-forDark darkMode btn btn-ghost hover:shadow hover:rounded-full" ></i>
                        <i className="fa-solid fa-moon logo-forLight darkMode btn btn-ghost hover:shadow hover:rounded-full "  ></i>
                    </div> */}

                    <div className="dropdown dropdown-end">
                        <div onClick={handleCartOpen} tabIndex={0} role="button" className="btn btn-ghost btn-circle NavLink">
                    ...
                    </div>
                    {
                        auth._id ? (
                            <div className="dropdown dropdown-end">
                                <div tabIndex={0} role="button" className="btn btn-ghost btn-circle avatar NavLink">
